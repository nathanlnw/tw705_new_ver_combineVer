...
static rt_size_t read_acc( void )
{
    ...
    static uint32_t NormalCounter = 0;
    ...
    if(err == ERR_NONE)
    {
        ...
        angle = abs(angle);
        if(angle > jt808_param.id_0x005E)
        {
            NormalCounter = 0;
            AlarmCounter++;
            if(AlarmCounter >= 3)
            {
                ...
                if(AlarmCounter == 3)
                {
                    debug_write((char *)mma845_print_str[0]);
        ...
        else if(angle < 15)
        {
            ...
            if(NormalCounter >= 3)
            {
                if(NormalCounter == 3)
                {
                    ...
                    {
                        debug_write((char *)mma845_print_str[1]);
                    }
                }
                jt808_param_bk.car_alarm &= ~( BIT_ALARM_TILT );
            }
...
void mma8451_process(void)
{
    ...
    {
        //p = (char *)mma845_print_str[mma845_print_style-1];
        //rt_kprintf( mma845_print_str[mma845_print_style-1] );
        debug_write((char *)mma845_print_str[mma845_print_style - 1]);
